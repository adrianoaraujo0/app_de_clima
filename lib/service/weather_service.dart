...
class WeatherService{
  ...
  Future<void> getCurrentInfo({required double latitude, required double longitude}) async{
    try{
  ...
  Future<void> getCityName({required double latitude, required double longitude}) async{
    try{
